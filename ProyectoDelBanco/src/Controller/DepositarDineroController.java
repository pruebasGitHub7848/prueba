...
public class DepositarDineroController {
    ...
    void btnDepositarDineroEvent(ActionEvent event) {
    	...
    	if(this.txtDineroDepositar.getText().equals("")) {
        	...
        	Double dinero = ICuenta.banco.getCliente().getDefCuenta().getSaldo();
        	
        	Double agregarDinero = ICuenta.banco.getCliente().getDefCuenta().setSaldo(dinero + txtDineroDepositar);
